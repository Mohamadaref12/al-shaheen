...
class OpenAiNewsImprovementService implements NewsImprovementService
{
    ...
    {
        return <<<PROMPT
You are an editorial assistant for a news platform. Improve the news item fields provided in JSON.
